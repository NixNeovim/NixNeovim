...
output=$(comm -23 pta_plugins me_plugins | sed -E "/${known_false_positives}/d")

gh issue create --title "Missing plugin detected" --body "I found the following missing plugins: $output"
